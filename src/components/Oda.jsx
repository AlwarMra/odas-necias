  ...
  return (
    <div className='poem'>
      ...
      <div className='poem__nav'>
        {isFirst ? '' : <NavLink className='poem__nav--prev bold' to={`/odas-necias/indice/${poems[indexOfPoem - 1]?.slug}`}><span className='poem__nav--arrow left'><span className='shaft' /></span> Anterior</NavLink>}
        {isLast ? '' : <NavLink className='poem__nav--next bold' to={`/odas-necias/indice/${poems[indexOfPoem + 1]?.slug}`}>Siguiente <span className='poem__nav--arrow right'><span className='shaft' /></span></NavLink>}
      </div>
